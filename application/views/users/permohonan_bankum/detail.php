        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-striped" width="100%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th valign="top" width="1">:</th>
                      <td><?php echo $query->kontak_client; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <th valign="top">:</th>
                      <td><?php echo $this->Mcrud->cek_status_permohonan($query->status); ?></td>
                    </tr>
                    <tr>
              ...
              <a href="<?php echo strtolower($this->uri->segment(1)); ?>/<?php echo strtolower($this->uri->segment(2)); ?>.html" class="btn btn-default"><< Kembali</a>
                   ...
                   <a class="btn btn-success" title="Edit" data-toggle="modal" onclick="modal_show(<?php echo $query->id_permohonan; ?>);" style="float:right;"><i class="fa fa-pencil"></i> Edit</a>
               
            </div>

            <div><?php echo $cek_notif->baca_notif; ?></div>
