            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-9">
                      <select class="form-control default-select2" name="id_kategori_lap" required>
                        ...
                        <?php foreach ($v_kat->result() as $key => $value): ?>
                          <option value="<?php echo $value->id_kategori_lap; ?>"><?php echo $value->nama_kategori_lap; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama_sub_kategori_lap" class="form-control" value="" placeholder="Nama Sub Kategori_lap" required>
                    </div>
                  </div>
                  <hr>
