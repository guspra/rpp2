            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama_kategori_lap" class="form-control" value="<?php echo $query->nama_kategori_lap; ?>" placeholder="Nama Kategori" required autofocus onfocus="this.value = this.value;">
                    </div>
                  </div>
                  <hr>
