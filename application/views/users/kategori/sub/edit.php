            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <select class="form-control default-select2" name="id_kategori" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama_sub_kategori" class="form-control" value="<?php echo $query->nama_sub_kategori; ?>" placeholder="Nama Sub Kategori" required>
                    </div>
                  </div>
                  <hr>
