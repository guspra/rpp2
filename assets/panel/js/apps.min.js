...
*/ var handleSlimScroll = function () {
  ...
  generateSlimScroll = function (e) {
    if (!$(e).attr("data-init")) {
      var a = $(e).attr("data-height"),
        t = { height: (a = a || $(e).height()), alwaysVisible: !0 };
  ...
  handleMobileSidebarToggle = function () {
    ...
    $(".sidebar").bind("click touchstart", function (a) {
      0 !== $(a.target).closest(".sidebar").length
        ? (e = !0)
      ...
      $(document).bind("click touchstart", function (a) {
        0 === $(a.target).closest(".sidebar").length && (e = !1),
          a.isPropagationStopped() ||
            !0 === e ||
            ($("#page-container").hasClass("page-sidebar-toggled") &&
              ((e = !0),
              $("#page-container").removeClass("page-sidebar-toggled")),
            $(window).width() <= 767 &&
              $("#page-container").hasClass("page-right-sidebar-toggled") &&
              ((e = !0),
      ...
      $("[data-click=right-sidebar-toggled]").click(function (a) {
        ...
        (t = $(window).width() < 979 ? "page-right-sidebar-toggled" : t),
          $("#page-container").hasClass(t)
            ? $("#page-container").removeClass(t)
            : !0 !== e
            ? $("#page-container").addClass(t)
            : (e = !1),
          $(window).width() < 480 &&
            $("#page-container").removeClass("page-sidebar-toggled"),
      ...
      $("[data-click=sidebar-toggled]").click(function (a) {
        ...
        $("#page-container").hasClass("page-sidebar-toggled")
          ? $("#page-container").removeClass("page-sidebar-toggled")
          : !0 !== e
          ? $("#page-container").addClass("page-sidebar-toggled")
          : (e = !1),
          $(window).width() < 480 &&
            $("#page-container").removeClass("page-right-sidebar-toggled");
      });
      ...
      $('#sidebar [data-scrollbar="true"]').css("margin-top", "0"),
        ...
        $("#page-container").hasClass("page-sidebar-minified")
          ? ($("#page-container").removeClass("page-sidebar-minified"),
            $("#page-container").hasClass("page-sidebar-fixed")
          ...
          : ($("#page-container").addClass("page-sidebar-minified"),
            /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
              ...
              ? ($('#sidebar [data-scrollbar="true"]').css("margin-top", "0"),
                $('#sidebar [data-scrollbar="true"]').css(
                  "overflow",
                  "visible"
                ))
              : ($("#page-container").hasClass("page-sidebar-fixed") &&
    ...
    $(e).sortable({
      ...
      stop: function (e, a) {
        a.item
          .find(".panel-title")
          .append(
            '<i class="fa fa-refresh fa-spin m-l-5" data-id="title-spinner"></i>'
          ),
  ...
  handleThemePageStructureControl = function () {
    if ($.cookie && $.cookie("theme")) {
      0 !== $(".theme-list").length &&
        ...
        $('.theme-list [data-theme="' + $.cookie("theme") + '"]')
          .closest("li")
          .addClass("active"));
    ...
    $.cookie &&
      ...
      $(document).on(
        "change",
        ".theme-panel [name=content-styling]",
        function () {
          2 == $(this).val()
            ? ($("body").addClass("flat-black"),
      ...
      $(document).on(
        "change",
        ".theme-panel [name=sidebar-fixed]",
        function () {
          1 == $(this).val()
            ? (2 == $(".theme-panel [name=header-fixed]").val() &&
                ...
                $('.theme-panel [name=header-fixed] option[value="1"]').prop(
                  "selected",
                  !0
                ),
              ...
              0 !== $(".sidebar .slimScrollDiv").length &&
                ($(window).width() <= 979
                  ...
                  : $(window).width() > 979 &&
                    ...
                    $('.sidebar [data-scrollbar="true"]').removeAttr("style"))),
              0 === $("#page-container .sidebar-bg").length &&
      ...
      $(document).on("change", ".theme-panel [name=header-fixed]", function () {
        1 == $(this).val()
          ...
          : (1 == $(".theme-panel [name=sidebar-fixed]").val() &&
              ...
              $('.theme-panel [name=sidebar-fixed] option[value="2"]').prop(
                "selected",
                !0
              ),
              $("#page-container").removeClass("page-sidebar-fixed"),
        ...
        $.when(
          $(".panel")
            ...
            .each(function () {
              ...
              e &&
                $.each(e, function (e, a) {
                  var t = $('[data-sortable-id="' + a.id + '"]').not(
                    '[data-init="true"]'
                  );
                  if (0 !== $(t).length) {
                    var n = $(t).clone();
  ...
  handleResetLocalStorage = function () {
    ...
    $(document).on("click", "[data-click=reset-local-storage]", function (e) {
      ...
      $(document).on(
        "click",
        "[data-click=confirm-reset-local-storage]",
        function (e) {
          e.preventDefault();
  ...
  handleIEFullHeightContent = function () {
    (window.navigator.userAgent.indexOf("MSIE ") > 0 ||
      ...
      $('.vertical-box-row [data-scrollbar="true"][data-height="100%"]').each(
        function () {
    ...
    function a(e, a) {
      ...
      switch (
        ...
        case "next":
          (l = o + i - n) <= n
            ...
            0 != s &&
              $(t)
                .find(".nav.nav-tabs")
                .animate({ marginLeft: "-" + s + "px" }, 150, function () {
        ...
        case "prev":
          var l = -i;
          l <= n
            ? ($(t).removeClass("overflow-left"), (s = 0))
            : (s = l - n + 80),
            $(t)
              .find(".nav.nav-tabs")
              .animate({ marginLeft: "-" + s + "px" }, 150, function () {
  ...
  handleMobileSidebar = function () {
    ...
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
      ...
      $('.page-sidebar-minified #sidebar [data-scrollbar="true"]').removeAttr(
        "style"
      ),
      $(".page-sidebar-minified #sidebar [data-scrollbar=true]").trigger(
        "mouseover"
      ));
    var e = 0;
    $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind(
      "touchstart",
      function (a) {
        var t = (
        ...
        e =
          t -
          parseInt($(this).closest("[data-scrollbar=true]").css("margin-top"));
      }
    ),
      $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind(
        "touchmove",
      ...
      $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind(
        ...
        function (a) {
          ...
          if (
            ...
            -parseInt(e) + $(".sidebar").height() >= s && i <= s && o <= s)
          ) {
            var l = i - s - 20;
            $(t).animate({ marginTop: l + "px" });
          } else
            parseInt(e) >= 0 || o >= s
              ? $(t).animate({ marginTop: "0px" })
              : ((l = e), $(t).animate({ marginTop: l + "px" }));
        }
      );
  },
  handleUnlimitedTopMenuRender = function () {
      ...
      switch (
        ...
        case "next":
          (l = o + i - n) <= n
            ...
            : (s = n - i - 128),
            0 != s &&
              $(t).animate({ marginLeft: "-" + s + "px" }, 150, function () {
        ...
        case "prev":
          var l = -i;
          l <= n
            ? ($(t).find(".menu-control.menu-control-left").removeClass("show"),
              (s = 0))
            : (s = l - n + 88),
            $(t).animate({ marginLeft: "-" + s + "px" }, 150, function () {
    ...
    function a() {
      ...
      if (
        ...
        var l = o - n + 128;
        $(e).animate({ marginLeft: "-" + l + "px" }, 0);
      }
      o != s && s >= n
        ? $(e).find(".menu-control.menu-control-right").addClass("show")
        : $(e).find(".menu-control.menu-control-right").removeClass("show"),
        o >= n && s >= n
          ? $(e).find(".menu-control.menu-control-left").addClass("show")
          : $(e).find(".menu-control.menu-control-left").removeClass("show");
    }
  ...
  handleClearSidebarSelection = function () {
    $(".sidebar .nav > li, .sidebar .nav .sub-menu")
      .removeClass("expand")
      .removeAttr("style");
  },
